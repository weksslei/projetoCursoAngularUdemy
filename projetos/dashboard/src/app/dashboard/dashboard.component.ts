...
declare var google: any; //A  palavra reservada declare dá a possibilidade de criar uma variável globol, como no caso desde projeto acessar o serviço do google.
